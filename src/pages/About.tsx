          ...
          <div className="max-w-3xl">
            <ScrollReveal>
              ...
              <div className="space-y-4 text-silver-dark leading-relaxed">
                ...
                <p>Today, Kaycha Group operates 10 laboratories across 9 states, employs over 200 scientists and professionals, and has tested more than one million samples. Our proprietary PureLIMS\u00ae technology platform, ISO 17025 accreditation at every location, and deep regulatory expertise position us as the trusted analytical partner for cultivators, processors, manufacturers, and dispensaries across the country.</p>
